                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" name="bus_name" placeholder="Enter Bus Name"  value="{{old('bus_name')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="time" name="timing"  value="{{old('timing')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" name="location" placeholder="Enter Location"  value="{{old('location')}}">
