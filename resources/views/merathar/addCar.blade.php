                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" name="car_model" placeholder="Enter Car Model"  value="{{old('car_model')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" placeholder="Enter Driver Experience" name="driver_experience"  value="{{old('driver_experience')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" name="contact_number" placeholder="Enter Contact Number"  value="{{old('contact_number')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" placeholder="Enter Driver Name" name="driver_name"  value="{{old('driver_name')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="file" name="car_image"  value="{{old('car_image')}}">
