                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" name="hotel_name"  value="{{old('hotel_name')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="file" name="hotel_image"  value="{{old('hotel_image')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="number" name="rating"  value="{{old('rating')}}">
