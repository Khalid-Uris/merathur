                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" name="dish_name" placeholder="Enter Dish Name"  value="{{old('dish_name')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" placeholder="Enter History" name="history"  value="{{old('history')}}">
