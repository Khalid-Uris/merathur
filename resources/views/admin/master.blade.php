                                    ...
                                    <div class="menu-submenu">
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{Route('city.show')}}" class="menu-link">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{Route('locationImage.show')}}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">Location Image</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{Route('hotel.show')}}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{Route('room.show')}}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{Route('bus.show')}}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{Route('car.show')}}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{Route('resturant.show')}}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">Resturant</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{Route('resturantImage.show')}}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
                                                    <span class="menu-text">Resturant Image</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{Route('culture.show')}}" class="menu-link">
                                                    <i class="menu-bullet menu-bullet-dot">
                                                        <span></span>
                                                    </i>
